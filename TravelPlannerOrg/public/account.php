...
<body>
  ...
  <main>
    <section id="account-section" class="page-section active">
      <h1 class="welcoming">ACCOUNT SETTINGS</span></h1>
      <div class="account-container">
        <div class="account-card">
          <h3>Profile Information</h3>
          <div class="profile-info">
              <?php if (!empty($fistName)): ?>
              <p><strong>Name:</strong> <span id="user-name"> <?= htmlspecialchars($fistName) ?> </span></p>            
              <?php endif; ?>           
             <p><strong>Email:</strong> <span id="user-email">Loading...</span></p>
            <p><strong>Member Since:</strong> <span id="user-created">Loading...</span></p>
            <p><strong>Total Trips:</strong> <span id="user-trips">0</span></p>
          </div>
